...
interface UpdateDiscountFormProps {
    ...
    onSave: (id: number, data: Omit<DiscountCode, 'id'>) => void;
}

const initialDiscountForm: DiscountCode = {
    id: 0,
    code: '',
    amount: 0,
    type: '',
...
const UpdateDiscountCodeForm = ({ discount, onSave }: UpdateDiscountFormProps) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        onSave(discount.id, discountForm);
    ...
    return (
        <form className="w-full" onSubmit={handleSubmit}>
            ...
            <div className="mb-4 flex flex-col gap-4">
                ...
                <Input
                    type="date"
                    value={new Date(discountForm.startDate).toISOString().split('T')[0]}
            ...
            <div className="mb-4 flex flex-col gap-4">
                ...
                <Input
                    type="date"
                    value={new Date(discountForm.endDate).toISOString().split('T')[0]}
